...
class SMWinservice(win32serviceutil.ServiceFramework):
    ...
    _svc_name_ = 'syncde'
    _svc_display_name_ = 'Sync dev_env'
    ...
    def main(self):
        auto_sync_git_diff_to_gdrive.main(['auto_sync_git_diff_to_gdrive.py', '-p', 'C:\\Users\\eharvin\\OneDrive - Ericsson AB\\000Vince\\programming\\git\\dev_env'])
...
if __name__ == '__main__':
    ...
    if len(sys.argv) != 1 and sys.argv[1] == "status":
        try: 
            serviceStatus = win32serviceutil.QueryServiceStatus('syncde')        
        except:
